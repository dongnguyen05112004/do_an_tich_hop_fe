<template>
    <div class="row">
        <h5 class="fw-bold">Khoản nợ gia đình</h5>
        <div class="row">
            <div class="col-lg-6">
                <div class="me-4">
                    <span class="fw-semibold">Tổng nợ hiện tại: 330.000.000 vnđ</span>
                </div>
                <div class="my-3">
            ...
            <div class="col-lg-6">
                <div class="me-4">
                    <span class="fw-semibold">Tiền nợ của bố: 150.000.000 vnđ</span>
                </div>
                <div class="mt-3">
                    <span class="fw-semibold">Tiền nợ của mẹ: 31.000.000 vnđ</span>
                </div>
            </div>
        </div>
    </div>
